...
public class KafkaConfig {
    ...
    @Value("${pyrosense.maintenance.kafka.dlq-topic:pyrosense.dead-letter.events}")
    private String dlqTopic;

    @Value("${pyrosense.maintenance.kafka.retry.max-attempts:3}")
    private int maxRetryAttempts;

    @Value("${pyrosense.maintenance.kafka.retry.backoff-ms:1000}")
    private long backoffMs;

    @Value("${pyrosense.maintenance.kafka.retry.backoff-multiplier:2}")
