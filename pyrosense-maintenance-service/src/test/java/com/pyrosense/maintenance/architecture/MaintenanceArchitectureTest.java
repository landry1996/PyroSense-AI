package com.pyrosense.maintenance.architecture;
...
@AnalyzeClasses(packages = "com.pyrosense.maintenance", importOptions = ImportOption.DoNotIncludeTests.class)
class MaintenanceArchitectureTest {
